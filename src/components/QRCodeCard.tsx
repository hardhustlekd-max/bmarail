    ...
    >
      ...
      >
        ...
        <div id="pvc-card-container" className="printable-id-card w-[580px] h-[366px] bg-white rounded-md shadow-2xl border border-slate-300 overflow-hidden text-slate-900 relative shrink-0 select-none font-sans flex flex-col justify-between">
          ...
          <div className="bg-primary text-white px-3.5 py-1.5 flex items-center justify-between relative min-h-[92px] shrink-0 border-b-2 border-yellow-500">
            ...
            <div className="flex flex-col items-center shrink-0 z-10 w-[68px]">
              ...
              <div className="bg-white text-primary text-[7.5px] font-black px-1.5 py-0.5 rounded-xs mt-0.5 border border-[#EAB308] whitespace-nowrap shadow-2xs">
                ማህበራዊ አገልግሎት
              </div>
            </div>
            ...
            <div className="flex flex-col items-center text-center flex-1 mx-1 z-10">
              ...
              <div className="mt-1 bg-[#EAB308] text-primary px-5 py-0.5 rounded-full shadow-sm border border-yellow-300 flex flex-col items-center">
          ...
          <div className="px-3.5 py-3 bg-white flex-1 flex items-center justify-between gap-3 relative">
            ...
            <div className="w-[125px] shrink-0 flex flex-col items-center">
              <div className="w-[120px] h-[155px] rounded-lg border-2 border-primary shadow-md overflow-hidden bg-slate-100 relative">
                <SmartImage
                  src={portraitPhoto}
                  alt="Member Portrait"
                  fallbackIcon="person"
            ...
            <div className="flex-1 min-w-0 pr-1 space-y-2 text-[12.5px] font-sans">
              ...
              <div className="flex items-start gap-1">
                <span className="font-extrabold text-primary min-w-[130px] shrink-0 text-[12px]">ሙሉ ስም / Full Name</span>
              ...
              <div className="flex items-center gap-1">
                <span className="font-extrabold text-primary min-w-[130px] shrink-0 text-[12px]">የአባል መለያ ቁጥር / ID No.</span>
                <span className="font-mono font-black text-slate-900 text-[13px]">: {idNo}</span>
              </div>

              {/* Plate No */}
              <div className="flex items-center gap-1">
                <span className="font-extrabold text-primary min-w-[130px] shrink-0 text-[12px]">የምዝገባ ሰሌዳ / Plate No.</span>
                <span className="font-mono font-black text-primary text-[13.5px]">: {plateNo}</span>
              </div>

              {/* Blood Group */}
              <div className="flex items-center gap-1">
                <span className="font-extrabold text-primary min-w-[130px] shrink-0 text-[12px]">የደም አይነት / Blood Group</span>
                <span className="font-black text-red-600 text-[13px]">: {bloodGroup}</span>
              </div>

              {/* Phone */}
              <div className="flex items-center gap-1">
                <span className="font-extrabold text-primary min-w-[130px] shrink-0 text-[12px]">ስልክ / Phone</span>
                <span className="font-mono font-bold text-slate-900 text-[12.5px]">: {phone}</span>
              </div>

              {/* Issue Date */}
              <div className="flex items-center gap-1">
                <span className="font-extrabold text-primary min-w-[130px] shrink-0 text-[12px]">የተሰጠበት ቀን / Issue Date</span>
                <span className="font-mono font-bold text-slate-900 text-[12.5px]">: {issueDate}</span>
              </div>

              {/* Expiry Date */}
              <div className="flex items-center gap-1">
                <span className="font-extrabold text-primary min-w-[130px] shrink-0 text-[12px]">የሚያበቃበት ቀን / Expiry Date</span>
            ...
            <div className="w-[120px] shrink-0 flex flex-col items-center justify-between h-[160px]">
              ...
              <div className="relative flex flex-col items-center mt-0.5">
                <div className="w-16 h-16 rounded-full border-2 border-double border-primary p-0.5 flex items-center justify-center relative bg-white">
                  <div className="w-full h-full rounded-full border border-dashed border-primary flex flex-col items-center justify-center p-0.5 text-[5.5px] font-black text-primary text-center">
                    <span>ባህርዳር ሞተረኞች</span>
                    <Icon className="material-symbols-outlined text-[16px] text-primary my-0.5">two_wheeler</Icon>
                    <span>ማህበር</span>
                  </div>
                ...
                <span className="text-[7.5px] font-bold text-primary mt-0.5 text-center leading-tight">
          ...
          <div className="bg-primary text-white py-1 px-3 text-center text-[10.5px] font-black tracking-wide shrink-0">
