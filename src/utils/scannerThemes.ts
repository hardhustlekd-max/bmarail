...
export const SCANNER_THEMES: Record<ScannerResultTheme, ScannerThemeConfig> = {
  ...
  warm_ivory_cream: {
    ...
    actionButton: 'bg-[#1e293b] hover:bg-[#162B5B] text-white shadow-xs',
  ...
  deep_cobalt_navy: {
    ...
    plateBadge: 'bg-[#0a1c44] text-blue-200 border border-slate-700/60',
  ...
  classic_blue: {
    ...
    palette: ['#dbeafe', '#bfdbfe', '#1e293b', '#f59e0b', '#059669'],

    containerBg: 'bg-blue-100 dark:bg-slate-950',
    bodyBg: 'bg-blue-100 dark:bg-blue-950/80',
    cardBg: 'bg-blue-200 dark:bg-blue-900/80 border-2 border-blue-300 dark:border-slate-800 text-slate-950 dark:text-white',
    ownerCardBg: 'bg-blue-200 dark:bg-blue-900/80 border-2 border-blue-300 dark:border-slate-800 text-slate-950 dark:text-white',
    specCardBg: 'bg-blue-200 dark:bg-blue-900/80 border-2 border-blue-300 dark:border-slate-800 text-slate-950 dark:text-white',
    chipBg: 'bg-blue-100/60 dark:bg-blue-950/40 border border-blue-300/60 dark:border-slate-800/60',
    iconCircle: 'bg-[#1e293b] text-amber-400 border border-amber-500/30 shadow-xs',
    actionButton: 'bg-[#1e293b] hover:bg-[#071330] text-amber-300 border border-amber-500/40 shadow-xs',
    plateBadge: 'bg-blue-50 dark:bg-blue-950/60 text-[#1e293b] dark:text-blue-300 border border-blue-300 dark:border-slate-800',
    ...
    sectionIconColor: 'text-[#1e293b] dark:text-blue-400',
